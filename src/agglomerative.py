...
def runAgglomerative(sample_size=None, score_graphs=False):
    """
    ...
    if sample_size:
        # dev, truncate the data to whatever the sample size is
        tracks = tracks.head(sample_size)
    ...
    # calculate dunn and silhouette as num clusters increases
    if score_graphs:
